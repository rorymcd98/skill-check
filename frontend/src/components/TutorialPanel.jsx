        ...
        <div id="tutorial-panel-images">
          <div className="TutorialImageContainer">
            ...
            <LazyLoadImage
              ...
              src="./tutorial-images/preset.png"
            ></LazyLoadImage>
          </div>
          <div className="TutorialImageContainer">
            ...
            <LazyLoadImage
              className="TutorialImage"
              src="./tutorial-images/custom.png"
            ></LazyLoadImage>
          </div>
          <div className="TutorialImageContainer">
            ...
            <LazyLoadImage
              className="TutorialImage"
              src="./tutorial-images/analyze.png"
            ></LazyLoadImage>
          </div>
          <div className="TutorialImageContainer">
          ...
          <div className="TutorialImageContainer">
            ...
            <LazyLoadImage
              className="TutorialImage"
              src="./tutorial-images/sliders.png"
            ></LazyLoadImage>
          </div>
          <div className="TutorialImageContainer">
